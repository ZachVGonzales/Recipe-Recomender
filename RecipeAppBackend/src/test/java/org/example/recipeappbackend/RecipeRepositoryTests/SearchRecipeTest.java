...
public class SearchRecipeTest {
    ...
    @Test
    public void testSearchRecipesSmall() throws SQLException {
    ...
    @Test
    public void testSearchRecipes100() throws SQLException {
        // Init DB
        for (int i = 0; i < 100; i++) {
    ...
    @Test
    public void testSearchRecipesNull() throws SQLException {
        // Init DB
        for (int i = 0; i < 200; i++) {
            jdbcTemplate.update(String.format("INSERT INTO recipes (id, name, minutes, instructions, ingredient_ids, ingredient_names) VALUES (123456789 + %d, 'Cake %d', 30, '[\"Step 1\", \"Step 2\"]', '[1, 2]', '[\"Flour\", \"Sugar\"]');", i, i));
        }
